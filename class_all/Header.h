...
class MRT : public LatticeBoltzmannComponents {
public: MRT();
...
private:
	...
	vector<double> Full_velocity_x, Full_velocity_y, Full_velocity_z, Full_rho, omega, Tcr, p_cr, mu, rho_cr, s, gamma, rho_max, G, w, rho_min, s_ii, m, m_eq;
	double wetWalls = 1;
	double wetObst = 1.;
	double sumG = 0, rho_mix_max, rho_mix_min;
	int volumeObs = 0;
